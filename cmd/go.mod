...
require (
	...
	github.com/dosco/graphjin/core/v3 v3.2.4
	github.com/dosco/graphjin/serv/v3 v3.2.4
...
require (
	...
	github.com/dosco/graphjin/auth/v3 v3.2.4 // indirect
	github.com/dosco/graphjin/plugin/otel/v3 v3.2.4 // indirect
