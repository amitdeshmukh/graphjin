...
require (
	...
	github.com/dosco/graphjin/core/v3 v3.3.0
	github.com/dosco/graphjin/serv/v3 v3.3.0
...
require (
	...
	github.com/dosco/graphjin/auth/v3 v3.3.0 // indirect
	github.com/dosco/graphjin/plugin/otel/v3 v3.3.0 // indirect
